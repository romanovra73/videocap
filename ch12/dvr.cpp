#include "dvr.h"
	...
	int grab_fails = 0;
	while (!isGrabbed) {
	    cout << "Unable to grab frame from " << this->ID << endl;
	    grab_fails++;
	    usleep(100000);
	...
	cout << "Try to connect DVR " << id <<  this->connection_string << endl;
	this->connect_DVR();
	this->channel = chan;
	...
	cout << "Width: " << this->frame_width << endl;
	this->ID = id;
    }
